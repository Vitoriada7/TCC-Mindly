...
- ícone com as primeiras letras do nome
- números imoportantes como: qtd conquistas feitas, qtd dias registrados, etc.
...
Essa tela deve possuir:

- mapa que possibilite o usuário identificar centros de apoio psicológico perto dele
- ícone para ligar para números de emergência (familiares, psicólogo)
- ícone para ligar para o centros de apoio

---

# Conquista

Essa tela deve conter uma lista de conquistas ligadas a gamificação, elas precisam ter status de concluída, desbloqueada(quando a pessoa começou) e bloqueada(quando ela ainda não começou).
...
- sempre separe os componentes por responsabilidade e idente o código para que fique legível e organizado.
